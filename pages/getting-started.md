...
{% include alert.html type="info" title="Information" content="AWS accounts requested wtih @ucsb.edu emails must be created in the Campus Cloud. You will receive an \"error processing your request\" when requesting a AWS Account with a @ucsb.edu email unless it is in the Campus Cloud LZ.<br> <br><a href=\"https://docs.cloud.ucsb.edu/docs/guidelines/account-request/\">More Info</a> %}
