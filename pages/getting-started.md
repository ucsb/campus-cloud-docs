...
{% include alert.html type="info" title="Information" content="AWS accounts requested wtih @ucsb.edu emails must be created in the Campus Cloud. You will revcieve an " error processing your request" when reqquesting a AWS Account with a @ucsb.edu email unless it is in the Campus Cloud LZ.  %}
