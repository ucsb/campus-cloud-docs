...
Cloud computing — also called the public cloud or the commercial cloud — provides
massive computing resources accessible over the internet. The major components are:

* **Compute:** Virtual machines and containers, from small to extremely powerful
* **Storage:** Effectively unlimited
* **Networking:** Connectivity to the internet and to other systems
* **Data management:** Databases, data warehouses, and analytics platforms
* **Services:** Machine learning, streaming data, serverless computing, and more

Amazon Web Services (AWS), Microsoft Azure, and Google Cloud Platform (GCP) are
among the largest Cloud Service Providers. They offer infrastructure as a service
(IaaS) and higher-level platform services (PaaS) from secure data centers in
multiple geographic locations. You pay only for what you use.
