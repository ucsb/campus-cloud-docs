...
Tags can also be used independently by account holders in the AWS Campus Cloud LZ.  In order to user Tags effectively we will define a vocabulary, namespace and [best practices](docs/bestpractices/).
